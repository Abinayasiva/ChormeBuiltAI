...
- **Origin Trial Token** - For accessing experimental AI features
...
4. **Get Origin Trial Token** (if needed)
   - Visit [Chrome Origin Trials](https://developer.chrome.com/origintrials/)
   - Sign up for the "Built-in AI" trial
   - Add your token to `manifest.json`

5. **Start Using ContextFlow**
...
**Made for Google Chrome Built-in AI Challenge 2025** 🚀

*Empowering researchers with AI, one tab at a time.*